    ...
    <div className="p-4">
      <div className=" grid grid-cols-1 md:grid-cols-3 gap-6 ">
        <div className="bg-white rounded-xl p-6 shadow border border-[#EBEBEB]">
          ...
          {/* DETAILS */}
          <div className=" ">
            <h4 className="font-semibold mb-3 mt-2 text-[#000000] text-lg">
              Details
            </h4>
            <ul className="text-sm space-y-2 text-gray-600">
              <li>
                <span className="font-medium text-[#333333] text-md">
                  Name:
                </span>{" "}
                <span className="text-[#7A7A7A] text-sm px-2">
                  Jacob Maicle
                </span>
              </li>
              <li>
              ...
              <li>
                ...
                <span className="text-[#7A7A7A] text-sm px-2">Aug 5, 2023</span>
              </li>
              <li>
                <span className="font-medium text-[#333333] text-md">
                  Language:
                </span>{" "}
                <span className="text-[#7A7A7A] text-sm px-2">English</span>
              </li>
            </ul>
          </div>
        </div>
