            ...
            <div className="max-w-full mx-auto w-full mb-6 flex-shrink-0">
              ...
              <div className="flex flex-col md:flex-row items-stretch md:items-end gap-3">
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <button className="ml-auto flex items-center gap-2 px-6 py-2.5 bg-[#024B5E] text-white rounded-lg text-sm font-semibold hover:bg-[#035F75] transition-all shadow-md active:scale-95 self-end cursor-pointer">
                    <Download size={18} />
                    Export
                  </button>
                </div>
