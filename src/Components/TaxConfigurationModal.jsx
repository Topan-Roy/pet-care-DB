    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <div
                ...
                onClick={onClose}
            />
            <div className="relative bg-white w-full max-w-[900px] rounded-[32px] shadow-2xl overflow-hidden flex flex-col p-10">
                <div className="flex items-center justify-between mb-5">
                    <h2 className="text-xl font-medium text-[#020617]">Add New Configuration</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="space-y-8">
                    <div>
                        <h3 className="text-[15px] font-normal text-[#0F172A] mb-2">Service Fees</h3>
                        <div className="h-px bg-gray-100 w-full" />
                    </div>
                    <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-[#374151]">Owner Service Fee (%)</label>
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-[#374151]">Sitter Service Fee (%)</label>
                            <div className="relative">
                                <input
                                    type="text"
                                    placeholder="e.g. 10"
                        ...
                        <div className="space-y-2 relative">
                            ...
                            {showTypeDropdown && (
                                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-100 rounded-xl shadow-xl z-[110] overflow-hidden">
                                    <button
                                        onClick={() => { setFeeType('Percentage'); setShowTypeDropdown(false); }}
                                        className="w-full px-4 py-3 text-left hover:bg-gray-50 text-sm transition-colors"
                                    >
                                        %
                                    </button>
                                    <button
                                        onClick={() => { setFeeType('Fixed'); setShowTypeDropdown(false); }}
                                        className="w-full px-4 py-3 text-left hover:bg-gray-50 text-sm transition-colors"
                                    >
                                        Fixed
                                    </button>
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-[#374151]">Sitter Tax Retention</label>
                            <div className="relative">
                                <input
                                    type="text"
                                    placeholder="e.g. 10"
                    ...
                    <div className="flex gap-4 pt-6">
                        ...
                        <button
                            className="flex-1 py-4 bg-[#024B5E] text-white rounded-2xl font-bold text-base hover:bg-[#024B5E] transition-all shadow-md active:scale-[0.98]"
                        >
                            Save Configuration
                        </button>
                    </div>
