...
const UserIcon = () => (
  ...
  >
    <path
      d="M4.32782 14.2316C2.91305 15.074 -0.796391 16.7941 1.46291 18.9466C2.56655 19.998 3.79573 20.75 5.34111 20.75H14.1594C15.7048 20.75 16.9339 19.998 18.0376 18.9466C20.2969 16.7941 16.5874 15.074 15.1727 14.2316C11.8551 12.2561 7.64543 12.2561 4.32782 14.2316Z"
      stroke="currentColor"
      strokeWidth="1.5"
    ...
    />
    <path
      d="M14.2502 5.25C14.2502 7.73528 12.2355 9.75 9.75024 9.75C7.26496 9.75 5.25024 7.73528 5.25024 5.25C5.25024 2.76472 7.26496 0.75 9.75024 0.75C12.2355 0.75 14.2502 2.76472 14.2502 5.25Z"
      stroke="currentColor"
      strokeWidth="1.5"
    />
  </svg>
...
const UsersIcon = () => (
  ...
  >
    <path
      d="M17.8663 17.25H18.3565C19.5064 17.25 20.421 16.7261 21.2421 15.9936C23.3283 14.1326 18.4244 12.25 16.7502 12.25M14.7502 2.31877C14.9773 2.27373 15.2131 2.25 15.455 2.25C17.2749 2.25 18.7502 3.59315 18.7502 5.25C18.7502 6.90685 17.2749 8.25 15.455 8.25C15.2131 8.25 14.9773 8.22627 14.7502 8.18123"
      stroke="currentColor"
      strokeWidth="1.5"
      stroke-linecap="round"
    />
    <path
      d="M3.73156 13.3612C2.55258 13.993 -0.538619 15.2831 1.34413 16.8974C2.26384 17.686 3.28815 18.25 4.57597 18.25H11.9245C13.2123 18.25 14.2367 17.686 15.1564 16.8974C17.0391 15.2831 13.9479 13.993 12.7689 13.3612C10.0043 11.8796 6.49623 11.8796 3.73156 13.3612Z"
      stroke="currentColor"
      strokeWidth="1.5"
    />
    <path
      d="M12.2502 4.75C12.2502 6.95914 10.4594 8.75 8.25024 8.75C6.04111 8.75 4.25024 6.95914 4.25024 4.75C4.25024 2.54086 6.04111 0.75 8.25024 0.75C10.4594 0.75 12.2502 2.54086 12.2502 4.75Z"
      stroke="currentColor"
      strokeWidth="1.5"
    />
  </svg>
...
const PromoIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M8.25 6.75H8.26122M13.2388 11.75H13.25"
      stroke="#585858"
      stroke-width="2"
      stroke-linecap="round"
      stroke-linejoin="round"
...
const PricingTaxes = () => (
  ...
  >
    <path
      d="M16.75 4.75C18.0501 4.8787 18.9252 5.16956 19.5784 5.82691C20.75 7.00596 20.75 8.90362 20.75 12.6989C20.75 16.4942 20.75 18.3919 19.5784 19.5709C18.4069 20.75 16.5212 20.75 12.75 20.75H8.75C4.97876 20.75 3.09315 20.75 1.92157 19.5709C0.75 18.3919 0.75 16.4942 0.75 12.6989C0.75 8.90362 0.75 7.00596 1.92157 5.82691C2.57475 5.16956 3.44989 4.8787 4.75 4.75"
      stroke="currentColor"
      strokeWidth="1.5"
      stroke-linecap="round"
    />
    <path
      d="M17.2578 12.75H17.2488"
      stroke="currentColor"
      strokeWidth="1.5"
      stroke-linecap="round"
      stroke-linejoin="round"
    ...
    />
    <path
      d="M13.25 12.75C13.25 14.1307 12.1307 15.25 10.75 15.25C9.36929 15.25 8.25 14.1307 8.25 12.75C8.25 11.3693 9.36929 10.25 10.75 10.25C12.1307 10.25 13.25 11.3693 13.25 12.75Z"
      stroke="currentColor"
      strokeWidth="1.5"
    />
    <path
      d="M8.25 3.25C8.74153 2.7443 10.0498 0.75 10.75 0.75M13.25 3.25C12.7585 2.7443 11.4502 0.75 10.75 0.75M10.75 0.75V6.75"
      stroke="currentColor"
      strokeWidth="1.5"
      stroke-linecap="round"
      stroke-linejoin="round"
  ...
  return (
    <div className="flex min-h-screen ">
      ...
      <aside className="w-64 bg-[#FFFFFF] border-r border-[#E3E6F0]  py-6">
        ...
        <p className="font-semibold text-sm text-[#666666] mt-5 mb-3 px-5">
          Menu
        </p>
      ...
      <main className="flex-1 ">
        ...
        <div className="">
          {showSummary && (
            <>
              {/* -------- DASHBOARD FILTERS (only home) -------- */}
              {isDashboardHome && <DashboardFilter />}
